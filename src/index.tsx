...
export const transformText = (raw: string): string | null => babelStandAlone.transform(raw, {
...
class CustomComponent extends React.Component<CustomComponentProps, {}> {
  public render() {
    return <div className="my-component">{this.props.children} {this.props.x * this.props.y}</div>;
  }
}

export const parseIncludeReactComponent = (funcText: string): React.ReactElement<any> => {
